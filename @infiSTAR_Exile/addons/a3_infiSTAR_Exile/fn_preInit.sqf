/*
	...
	licensed to:
	'nathan.lloyd1983@googlemail.com'
...
_response = "armalog" callExtension ("154322a0e8e73&l=74691eca20c5390f1dd7ff4b8129e799&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> 54322a0e8e73";
	diag_log "<infiSTAR.de> 74691eca20c5390f1dd7ff4b8129e799";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"exile"+";;"+_logname+";;"+_logentry+";;"+"03-07-2018 10-04-18 - v93");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format['<infiSTAR.de>%1| %2   [03-07-2018 10-04-18 - v93]',_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [1000MS - 03-07-2018 10-04-18 - v93 - %2 - %3]',time,serverName,productVersion];
...
0 spawn {[["http://armalog.infistar.de/remote.php?key=74691eca20c5390f1dd7ff4b8129e799&m=exile"] call FN_ARMA_FETCHDATA] call {_this params [["_ret","",[""]]];if!(_ret isEqualTo "")then{call compile _ret;};};};
true
